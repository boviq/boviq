...
_riot2.default.tag2('boviq-post', '<div class="post-avatar"> </div> <h3 class="post-title">{title}</h3> <div class="post-content">{content}</div> <div class="post-time">{created_at}</div>', '', '', function (opts) {
