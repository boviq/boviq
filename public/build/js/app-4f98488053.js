...
},{"./createStore":303,"./utils/warning":305,"_process":298,"lodash/isPlainObject":309}],302:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":309,"symbol-observable":310}],304:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":299,"./bindActionCreators":300,"./combineReducers":301,"./compose":302,"./createStore":303,"./utils/warning":305,"_process":298}],305:[function(require,module,exports){
'use strict';
...
},{"./_getPrototype":306,"./_isHostObject":307,"./isObjectLike":308}],310:[function(require,module,exports){
(function (global){
/* global window */
'use strict';
...
var reducer = function reducer() {
    var state = arguments.length <= 0 || arguments[0] === undefined ? { title: 'Default title' } : arguments[0];
    var action = arguments[1];

    return state;
};

var store = (0, _redux.createStore)(reducer, __INITIAL_STATE__);

jQuery(document).ready(function ($) {
    _riot2.default.mount('posts-list', { store: store });
});

_riot2.default.tag2('boviq-post', '<div class="post-avatar"> </div> <h3 class="post-title">{opts.store.getState().title}</h3> <div class="post-content">{content}</div> <div class="post-time">{created_at}</div>', '', '', function (opts) {
...
_riot2.default.tag2('posts-list', '<div class="post" each="{post in opts.store.getState().posts}"> <div class="post-avatar"> </div> <h3 class="post-title">{post.title}</h3> <div class="post-content">{post.content}</div> </div>', '', '', function (opts) {});

},{"babel-polyfill":1,"redux":304,"riot":312}]},{},[313]);
